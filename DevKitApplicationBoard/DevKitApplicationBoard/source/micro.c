...
void MicroInit()
{
	...
	ConfigureInput (MODE1_JUMPER_PORT, MODE1_JUMPER_MASK, ENABLED);
	ConfigureInput (MODE2_JUMPER_PORT, MODE2_JUMPER_MASK, ENABLED);
	ConfigureInput (MODE3_JUMPER_PORT, MODE3_JUMPER_MASK, ENABLED);
}
